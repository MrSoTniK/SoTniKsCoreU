...
{
    public abstract class EcsStartup<TSceneType, TSceneInfo> : IDisposable 
        ...
        where TSceneInfo : SceneInfoAbstract<TSceneType>
    {
        ...
        protected TSceneType SceneType;
        ...
        public void SetStartup(WorldsInfo worldsInfo, TSceneInfo sceneInfo) 
        {
